...
test: tests.cc contract.hpp read.hpp
	g++ -std=c++20 -I/home/saurabh/hopscotch-map/include -g -o tests tests.cc
...
all: driver.cc contract.hpp read.hpp
	...
	g++ -std=c++20 -g -I/home/saurabh/hopscotch-map/include -I/home/saurabh/taskflow -o driver driver.cc
