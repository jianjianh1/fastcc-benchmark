...
all: driver.cc contract.hpp read.hpp
	clang++ -std=c++20 -O3 -g -march=native -mtune=native -ffast-math -I/usr/include/c++/11 -I/usr/include/x86_64-linux-gnu/c++/11 -I/home/saurabh/taskflow -I/home/saurabh/hopscotch-map/include -L /usr/lib/gcc/x86_64-linux-gnu/11 -o driver driver.cc
