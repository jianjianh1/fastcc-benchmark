...
all: driver.cc contract.hpp read.hpp
	g++ -std=c++20 -Ofast -march=native -mtune=native -ffast-math -I/home/saurabh/taskflow -o driver driver.cc
	#g++ -std=c++20 -g -I/home/saurabh/taskflow -o driver driver.cc
	#g++ -std=c++20 -fsanitize=address -g -I/home/saurabh/taskflow -o driver driver.cc
